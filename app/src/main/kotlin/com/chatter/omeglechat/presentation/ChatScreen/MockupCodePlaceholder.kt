...
internal val chatMessages = mutableListOf(
    ...
    Message(0, "Doing fine"),
    Message(1, "How @fanthom"),
    Message(1, "I really like you @Romeo"),
    Message(0, "Nice to meet  you"),
